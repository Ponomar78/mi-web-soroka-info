...
Дивіться **[НА_MAC_ПОДВІЙНИЙ_КЛІК.md](НА_MAC_ПОДВІЙНИЙ_КЛІК.md)** і **[ЩО_ТЕСТУЄМО.md](ЩО_ТЕСТУЄМО.md)**.

У вікні Mac після оновлення:
- **ПОВНИЙ СКАН + звіт** — інфо, батарея, Wi‑Fi, crash/**panic-full**, HTML з підказками (вкл. «немає звуку / мокрий»)
- **Panic-full / креші**, **Аналіз (звук/вода)**, **Syslog audio**

Face ID / NFC / динамік «на слух» — апка в `ios-app/` або ручний тест на телефоні.
